        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link text-nowrap active" href="all_cust.php">View Customers</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
    ...
    <center>
        ...
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            <div
                ...
                <h1 style=" color:blue;">All Customers</h1>
            </div>
            <?php
...
?>
            <table class="table table" style="margin-top: 30px;background-color:#87c9e8">
                <thead>
                    <tr>
