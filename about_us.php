...
<body style="background-color:lavender;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <b>
                <ul class="navbar-nav ">
                    <li class="nav-item nav-links" style="margin-left:20px;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <p style="color:black;">This Present website is created by</p>
            <h1 style="color:blue; text-shadow:2px 2px 2px gray;">Priyanka Bonala</h1>
            <p style="color:grey;"><b>Intern at Sparks Foundation <br></p>
    </center>
