...
<body style="background-color:lavender; padding-top:8%;">
            ...
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px; ">
                        <a class="nav-link text-nowrap active" href="send_money.php">Transfer Money</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
    ...
    <center>
        ...
        <div class="container" style="margin-top:2%;">
            <div
                style="width:80%; background-color:white; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px blue;">
                <h1 style=" color:blue;">Transfer Amount</h1>
            </div>
            <br><br>
            <div class="" style=" backdrop-filter: blur(5px);  border-radius:5px;  ">
                <form action="send_money.php" method="post">
                    ...
                    <br><input class="btn mybtn btn-outline-dark" type="submit" value="Transfer"><br><br>
